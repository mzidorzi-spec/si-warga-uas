    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="card-header bg-warning bg-gradient py-3 px-4 border-0">
                    <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-pencil-square me-2"></i> Edit Data Warga</h5>
                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nik" class="form-control border-start-0 bg-white" value="{{ old('nik', $warga->nik) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control border-start-0 bg-white" value="{{ old('nama_lengkap', $warga->nama_lengkap) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label class="form-label fw-bold">Blok Rumah</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0"><i class="bi bi-house-door text-muted"></i></span>
                                    <input type="text" name="blok_rumah" class="form-control border-start-0 bg-white" value="{{ old('blok_rumah', $warga->blok_rumah) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="no_hp" class="form-control border-start-0 bg-white" value="{{ old('no_hp', $warga->no_hp) }}" required>
                                </div>
                            </div>
                        </div>
